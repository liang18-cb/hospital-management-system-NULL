...
<head>
    <meta charset="utf-8">
    <title>Pengingat Janji Temu Medis</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333333; padding: 20px;">
    ...
    <p>Ini adalah pengingat bahwa Anda memiliki jadwal janji temu medis yang terdaftar untuk <strong>besok hari</strong>:</p>
    <table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
        ...
        <tr>
            ...
            <td style="padding: 5px; font-weight: bold; color: #0284c7;">: {{ $appointment->queue_number ?? '-' }}</td>
        </tr>
    </table>
    <p style="margin-top: 20px;">Jika Anda berhalangan hadir, silakan hubungi administrasi klinik. Terima kasih.</p>
</body>
</html>